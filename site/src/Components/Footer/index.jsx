...
export default function Footer() {
  ...
  return (
     <footer className=" bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                <img src="https://www.floatui.com/logo.svg" className="w-32 sm:mx-auto" />
                <p className=" font-vanitasr text-lg leading-relaxed mt-2 text-[15px]">
            ...
            <ul className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0">
                {
                    footerNavs.map((item, idx) => (
                        <li key={idx} className=" hover:text-gray-800 font-vanitasb">
                            <a href={item.href}>
                                { item.name }
                            </a>
                        </li>
            ...
            <div className="mt-8 items-center justify-between sm:flex">
                <div className="font-vanitasr text-md mt-4 sm:mt-0">
